...
import '@/styles/PortableFeaturedCharactersSection.css';
import { PortableCharacterCard } from "./PortableCharacterCard";
...
export default function PortableFeaturedCharactersSection() {
  return (
    <section className="portable-featured-characters-section">
      <div className="max-w-6xl mx-auto relative z-10">
        <h2 className="text-4xl font-bold mb-12 text-center section-title">Featured Characters</h2>
        <div className="portable-featured-characters-cards-container">
          {characters.map((character) => (
            <PortableCharacterCard key={character.name} character={character} />
          ))}
        </div>
