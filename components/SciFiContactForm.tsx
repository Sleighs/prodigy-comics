...
export default function SciFiContactForm({ className = '' }: SciFiContactFormProps) {
  ...
  return (
    <section className={`py-16 px-4 md:px-8 max-w-6xl mx-auto ${className}`}>
      <h2 className="text-3xl md:text-4xl font-bold mb-8 font-roboto-condensed tracking-wider text-white">
        <span className="text-red-500">[</span> TRANSMISSION INTERFACE <span className="text-red-500">]</span>
      </h2>
      
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Contact Form - Holographic Terminal */}
          ...
          <div className="relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-mono tracking-widest text-red-400">
                  [ TRANSMISSION TYPE ]
                </label>
                <select
                  name="category"
                  ...
                  className="w-full bg-black/50 border border-red-500/30 text-white px-4 py-3 font-mono tracking-wide focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all"
                >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full bg-black/50 border border-red-500/30 text-white px-4 py-3 font-mono tracking-wide focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all resize-none"
              ...
              {submitStatus === 'success' && (
                <div className="mt-4 p-4 bg-green-900/20 border border-green-500/50 text-green-400 font-mono tracking-wide">
                  ✓ TRANSMISSION SUCCESSFUL - MESSAGE RECEIVED
                </div>
              )}
              {submitStatus === 'error' && (
                <div className="mt-4 p-4 bg-red-900/20 border border-red-500/50 text-red-400 font-mono tracking-wide">
        ...
        <div className="relative overflow-hidden rounded-lg bg-black/20 backdrop-blur-sm p-8">
          ...
          <div className="relative space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <h4 className="text-sm font-mono tracking-widest text-red-400">[ PRIMARY FREQUENCY ]</h4>
              ...
              <div className="space-y-2">
                <h4 className="text-sm font-mono tracking-widest text-red-400">[ PRESS & MEDIA ]</h4>
              ...
              <div className="space-y-2">
                <h4 className="text-sm font-mono tracking-widest text-red-400">[ ALLIANCE REQUESTS ]</h4>
              ...
              <div className="space-y-2">
                <h4 className="text-sm font-mono tracking-widest text-red-400">[ CAMPAIGN LINK ]</h4>
            ...
            <div className="pt-6 border-t border-red-500/20">
              <h4 className="text-sm font-mono tracking-widest text-red-400 mb-4">[ NETWORK NODES ]</h4>
              <div className="grid grid-cols-2 gap-3">
                <a href={contactInfo.social.twitter} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group">
                  ...
                  <span className="text-white/70 group-hover:text-red-400 font-mono text-xs tracking-wide">X/TWITTER</span>
                </a>
                <a href={contactInfo.social.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group">
                  ...
                  <span className="text-white/70 group-hover:text-red-400 font-mono text-xs tracking-wide">INSTAGRAM</span>
                </a>
                <a href={contactInfo.social.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group">
                  ...
                  <span className="text-white/70 group-hover:text-red-400 font-mono text-xs tracking-wide">YOUTUBE</span>
                </a>
                <a href={contactInfo.social.discord} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group">
                  ...
                  <span className="text-white/70 group-hover:text-red-400 font-mono text-xs tracking-wide">DISCORD</span>
                </a>
              </div>
            </div>
          </div>
